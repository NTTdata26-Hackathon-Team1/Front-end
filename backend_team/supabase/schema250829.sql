...
COMMENT ON TABLE "public"."User_list" IS '名前入力フォームの内容';
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."User_list" FOR INSERT WITH CHECK (true);



CREATE POLICY "Enable read access for all users" ON "public"."User_list" FOR SELECT USING (true);
...
GRANT ALL ON TABLE "public"."User_list" TO "anon";
GRANT ALL ON TABLE "public"."User_list" TO "authenticated";
GRANT ALL ON TABLE "public"."User_list" TO "service_role";
